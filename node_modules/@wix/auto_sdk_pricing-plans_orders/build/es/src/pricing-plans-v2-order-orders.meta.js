...
export function createOnlineOrder() {
    const payload = {};
    const getRequestOptions = ambassadorWixPricingPlansV2Order.createOnlineOrder(payload);
    const getUrl = (context) => {
        const { url } = getRequestOptions(context);
        return url;
    };
...
export function getOnlineOrderPreview() {
    const payload = {};
    const getRequestOptions = ambassadorWixPricingPlansV2Order.getOnlineOrderPreview(payload);
    const getUrl = (context) => {
        const { url } = getRequestOptions(context);
        return url;
    };
...
//# sourceMappingURL=pricing-plans-v2-order-orders.meta.js.map